...
def run_prosail(n, cab, car,  cbrown, cw, cm, cp, cbc, lai, lidfa, hspot,
    ...
    wv, refl, trans = run_prospect (n, cab, car,  cbrown, cw, cm, cp, cbc, ant=ant, 
...
# result = run_prosail(n=1.5, cab=40, car=8, cbrown=0.0, cw=0.01, cm=0.009, lai=3.0, lidfa=-0.35, lidfb=-0.15, rsoil=0.2, psoil=0.3, hspot=0.01, tts=30.0, tto=10.0, psi=0.0, typelidf=1)
# print(result)